...
export const selectFilteredCampers = createSelector(
  ...
  (campers, nameFilter, locationFilter, formFilter, equipment) => {
    ...
    return campers.filter(camper => {
      ...
      // const matchesForm =
      //   Object.values(FormEnum).includes(camper.form) &&
      //   camper.form.includes(formFilter.toLowerCase().trim());
      // const matchesAC =
      //   typeof camper.AC === 'boolean' ? camper.AC === acFilter : true;
      ...
      //     ? camper.kitchen === kitchenFilter
      //     : true;
      // const matchesTV =
      //   typeof camper.TV === 'boolean' ? camper.TV === tvFilter : true;
      // const matchesBathroom =
      //   typeof camper.bathroom === 'boolean'
      //     ? camper.bathroom === bathroomFilter
      //     : true;

      return (
        // matchesName || matchesLocation || matchesForm
        // matchesAC ||
        // matchesTransmission ||
        // matchesKitchen ||
        // matchesTV ||
